...
import Navbar from "../components/acheteur/Navbar";
import Hero from "../components/acheteur/Hero";
import CategoryTabs from "../components/acheteur/CategoryTabs";
import ProductGrid from "../components/acheteur/ProductGrid";
import VendorsSection from "../components/acheteur/VendorsSection";
import GuestPrompt from "../components/acheteur/GuestPrompt";

const Acheteur: React.FC = () => {
